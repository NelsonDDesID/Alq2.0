...
<div class="banner"><?php if ($page['banner']): ?>
    <div>
...
<div class="footer">
  <a class="logo" href="http://www.alqueria.com.co/" target="_blank"><img src="<?= $GLOBALS['base_path'] . path_to_theme() ?>/img/footer-flange.png" /></a>
  <div class="body-content">
    <div class="left">
